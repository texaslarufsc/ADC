...
void Setup_GPIO(void){
    ...
    GpioCtrlRegs.GPAPUD.bit.GPIO31 = 0;    //DESLIGA RESISTOR DE PULL UP
    GpioCtrlRegs.GPBPUD.bit.GPIO34 = 0;    //DESLIGA RESISTOR DE PULL UP

    GpioCtrlRegs.GPAGMUX2.bit.GPIO31 = 0;  //CONFIGURANDO GRUPO DO MUX COMO 0
    GpioCtrlRegs.GPAMUX2.bit.GPIO31 = 0;   //CONFIGURANDO O MUX COMO GPIO
    GpioCtrlRegs.GPADIR.bit.GPIO31 = 1;    //PINO CONFIGURADO COMO SAÍDA

    GpioCtrlRegs.GPBGMUX1.bit.GPIO34 = 0;   //CONFIGURANDO GRUPO DO MUX COMO 0
    GpioCtrlRegs.GPBMUX1.bit.GPIO34 = 0;    //CONFIGURANDO O MUX COMO GPIO
    GpioCtrlRegs.GPBDIR.bit.GPIO34 = 1;     //PINO CONFIGURADO COMO SAÍDA

    GpioCtrlRegs.GPBGMUX1.bit.GPIO35 = 0;   //CONFIGURANDO GRUPO DO MUX COMO 0
    GpioCtrlRegs.GPBMUX1.bit.GPIO35 = 0;    //CONFIGURANDO O MUX COMO GPIO
    GpioCtrlRegs.GPBDIR.bit.GPIO35 = 0;     //PINO CONFIGURADO COMO ENTRADA
    GpioCtrlRegs.GPBQSEL1.bit.GPIO35 = 0;    //MANUAL DE REFERÊNCIA, PAGINA 971, TABELA 8.15, SINC. COM CLOCK
    //GpioCtrlRegs.GPxCTRL.bit.QUALPRD[0...4] //CONFIGURAR SAMPLES
    GpioCtrlRegs.GPBCSEL1.bit.GPIO35 = GPIO_MUX_CPU1;   //PINO CONTROLADO PELA CPU 1 (PADRÃO)
    ...
    GpioCtrlRegs.GPAGMUX1.bit.GPIO14 = 0;  //CONFIGURANDO GRUPO DO MUX COMO 0
    GpioCtrlRegs.GPAMUX1.bit.GPIO14 = 0;   //CONFIGURANDO O MUX COMO GPIO
    GpioCtrlRegs.GPAPUD.bit.GPIO14 = 1;    //PINO CONFIGURADO COMO SAÍDA
...
void Setup_ADC(void){
    ...
    AdcaRegs.ADCSOC0CTL.bit.TRIGSEL = 0x05; //Seleciona qual evento irá disparar o ADC (ePWM1) - Tabela 11-33 do Manual

    AdcaRegs.ADCSOC1CTL.bit.CHSEL = 4; //Pino ADC = 4
    AdcaRegs.ADCSOC1CTL.bit.ACQPS = acqps; //Tamanho da janela de amostragem = 14 + 1
    AdcaRegs.ADCSOC1CTL.bit.TRIGSEL = 0x05; //Seleciona qual evento irá disparar o ADC (ePWM1) - Tabela 11-33 do Manual
